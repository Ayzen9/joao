...
export function Header() {
  const { cart, comboItems, openCart } = useCart()

  const totalItems = cart.items.length + comboItems.length
      ...
      <div className="bg-[#005da8] text-white">
        <div className="max-w-[2000px] mx-auto px-6">
          <nav className="flex items-center justify-between py-4 h-[85px]">
            ...
            <img src="/images/nova_logo.png" alt="CAIXA Loterias" className="h-[100px]" />
